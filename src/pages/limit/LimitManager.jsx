            ...
            <div>
                <Form layout='inline' className="container" onSubmit={this.handleSearch}>
                    <div className="select">
                        <MapSelectComs formTemp={formTemp} selectedAll={true} initial={true}
                                       wrappedComponentRef={(inst) => this.formData = inst} data={selectsData}/>
                    </div>
                    <Row>
                        ...
                        <Col {...layout} style={{marginLeft: 6}}>
                            ...
                            <div className="selBtn" style={{textAlign: 'right'}}>
                                <FormItem style={{margin: "10px", float: 'left'}}
                                          label={(<div className="label-class">限额名称</div>)}>
                                    {
                ...
                <Card noHovering="true" className="limitable" title="限额列表" bodyStyle={{padding: '0px',}}><Table
                    className="btl"
                    columns={columns}
                    dataSource={
                        modelsData.records
