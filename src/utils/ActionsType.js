...
// 查询消费类型下拉纬度
export const API_GET_PERSIONAL_CONSUMPTION = ['REQUEST', 'GET_PERSONAL_LIMIT_SUCCESS', 'FAILURE'];

// 查询在线交易类型下拉纬度
export const API_GET_PERSIONAL_ONLINE = ['REQUEST', 'GET_PERSONAL_LIMIT_SUCCESS', 'FAILURE'];

// 查询消费类型下拉纬度
export const API_GET_PERSIONAL_ONLINEPAY = ['REQUEST', 'GET_PERSONAL_LIMIT_SUCCESS', 'FAILURE'];