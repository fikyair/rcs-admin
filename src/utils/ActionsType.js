...
// 修改个性限额
export const  API_UPDATE_PERSONAL_LIMIT =  ['REQUEST', 'GET_PERSONAL_LIMIT_SUCCESS', 'FAILURE'];
// 删除个性限额
export const  API_DELETE_PERSIONAL_MODEL =  ['REQUEST', 'GET_PERSONAL_LIMIT_SUCCESS', 'FAILURE'];
// 添加个性限额
export const  API_POST_PERSIONAL_MODEL =  ['REQUEST', 'GET_PERSONAL_LIMIT_SUCCESS', 'FAILURE'];
